...
### Step 2: Develop Core Architectural Catalogs
...
### Step 3: Map Architecture to Value Streams

1. **Decompose Value Streams:** Decompose the top-level `ValueStreams` from Part 1 into stages.
