...
"VS_L1_DMG_BM","ValueStream","Build & Maintain","The operational process of constructing new assets and performing ongoing maintenance on existing infrastructure."
...
"CAP_L1_ND","Capability","Network Development","The ability to design, engineer, and manage the construction of new grid infrastructure."
...
"","CompositionRelationship","","","VS_L0_DMG","VS_L1_DMG_BM",""
"","CompositionRelationship","","","VS_L1_DMG_PD","VS_L2_DMG_1",""
"","CompositionRelationship","","","VS_L1_DMG_PD","VS_L2_DMG_2",""
"","CompositionRelationship","","","VS_L1_DMG_BM","VS_L2_DMG_3",""
"","CompositionRelationship","","","VS_L1_DMG_BM","VS_L2_DMG_4",""
...
"","ServingRelationship","","","CAP_L1_SAP","VS_L1_DMG_PD",""
...
"","ServingRelationship","","","CAP_L1_AOM","VS_L1_DMG_BM",""
...
"","ServingRelationship","","","CAP_L1_LGF","VS_L1_DE_OP",""
"","ServingRelationship","","","CAP_L2_LGF_DF","VS_L2_DE_1",""
"","ServingRelationship","","","CAP_L1_SBO","VS_L1_DE_OP",""
...
"","ServingRelationship","","","CAP_L1_ND","VS_L1_CNS_PS",""
...
"","AssociationRelationship","","","CAP_L2_ICP","BO_L1_TDI",""
"","AssociationRelationship","","","CAP_L1_ND","BO_L1_TDI",""
"","AssociationRelationship","","","CAP_L2_NTP","BO_L2_GTM_N",""
"","AssociationRelationship","","","CAP_L2_BIDE","BO_L1_TDI",""
...
"","AssociationRelationship","","","CAP_L2_RIT","BO_L1_TDI",""
...
"","AssociationRelationship","","","CAP_L2_CCE","BO_L1_TDI",""
...
"","AssociationRelationship","","","CAP_L0_EMO","BO_L0_GSA",""
...
"VS_L1_DMG_BM","Level","1"
"VS_L1_DMG_BM","Sequence","2"
"VS_L2_DMG_3","Level","2"
"VS_L2_DMG_3","Sequence","3"
"VS_L2_DMG_4","Level","2"
"VS_L2_DMG_4","Sequence","4"
"VS_L0_DE","Level","0"
...
"VS_L2_CNS_3","Level","2"
"VS_L2_CNS_3","Sequence","3"
"VS_L2_CNS_4","Level","2"
"VS_L2_CNS_4","Sequence","4"
"CAP_L0_GAM","Level","0"
"CAP_L1_SAP","Level","1"
"CAP_L2_AHRA","Level","2"
"CAP_L2_ICP","Level","2"
...
VALIDATION SUMMARY:
  - Total Violations: 61/592 (10.3%)
  - FAILED Rules: C4, C5, C7, C8, C9
  - PASSED Rules: C0, C1, C2, C3, C6, C10
...
[!!] C4 - Upward coherence: 18/66 (27.27%)
----------------------------------------------------------------------
 ...
 * Examples of violating items: 
   ...
   - serving-relationship: (Network Development) --> (Process & Study)
   - serving-relationship: (Market Settlement & Reconciliation) --> (Metering & Billing)
   - association-relationship: (Investment & Capital Planning) --> (Transmission & Distribution Infrastructure)
   - association-relationship: (Network Topology Planning) --> (Network Model)

[!!] C5 - Downward coherence: 15/41 (36.59%)
----------------------------------------------------------------------
 ...
 * Examples of violating items: 
   - serving-relationship: (Transmission Rights Management) --> (System Balancing & Optimization)
   - serving-relationship: (Market Settlement & Reconciliation) --> (Metering & Billing)
   - association-relationship: (Investment & Capital Planning) --> (Transmission & Distribution Infrastructure)
   - association-relationship: (Network Development) --> (Transmission & Distribution Infrastructure)
   - association-relationship: (Bulk Infrastructure Design & Engineering) --> (Transmission & Distribution Infrastructure)

[!!] C7 - Object Relevance: 7/31 (22.58%)
----------------------------------------------------------------------
 ...
 * Examples of violating items: 
   - business-object: Transmission & Distribution Infrastructure
   - business-object: Substation
   - business-object: Transformer
   - business-object: Real-Time Grid Data
   - business-object: Grid Service Agreement

[!!] C8 - Capability Purpose: 18/45 (40%)
----------------------------------------------------------------------
 ...
 * Examples of violating items: 
   ...
   - capability: Vegetation Management
   - capability: Generation Forecasting
   - capability: EMS/DMS Operation
   - capability: Outage Detection & Localization

[!!] C9 - Traceability: 3/21 (14.29%)
----------------------------------------------------------------------
 * Statement: Each value stream stage must be realized by exactly one capability.
 * Examples of violating items: 
   - value-stream: Plan & Design
   - value-stream: Operate & Monitor
   - value-stream: Process & Study
